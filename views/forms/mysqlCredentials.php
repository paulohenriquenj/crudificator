    ...
    <div class="col-md-8 order-md-1">
        ...
        <form action="/database/tableInfo" method="POST" class="needs-validation" novalidate autocomplete="off">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="host" name="host" placeholder="Ex.: 192.168.0.0">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="database" name="database" placeholder="Banco">
                </div>
            </div>
            <div class="form-group row">
                <label for="table" class="col-sm-2 col-form-label">Tabela</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="table" name="table" placeholder="Tabela">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-10">
